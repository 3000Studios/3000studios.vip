export const rolloutSongs = [
  {
    rank: 1,
    title: 'Big Old Hands — Tore Up The Hole',
    description: 'Feature song · Krust · Heavy-hitting original for the VIP red carpet rollout.',
    src: '/media/big-old-hands-tore-up-the-hole.mp3',
  },
  {
    rank: 2,
    title: 'Always Late',
