...
export function SongPage() {
  ...
  // Simple themed game: "Vibe Tap" - tap to catch floating words that match the song vibe
  ...
  const spawnVibe = () => {
    ...
    const newItem = { id: Date.now(), text: word, x: Math.random()*70 + 15, y: Math.random()*40 + 30 };
  ...
  return (
    <div className="songDetailPage">
      ...
      <div className="playerSection">
        <audio ref={audioRef} src={song.fullAudio} />
        ...
        <div className="playerControls">
          ...
          <div className="playerMeta">
            {canPlayFull ? 'FULL TRACK • LOOPING' : '10s PREVIEW'}
          </div>
        </div>
