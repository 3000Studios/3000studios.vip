...
export function YouTubeSubscriberPerk() {
  ...
  return (
    <>
      ...
      {open ? (
        <div
          className="ytSubModalScrim"
          role="dialog"
          aria-modal="true"
          aria-label="Subscribe on YouTube"
        >
          <div ref={trapRef} className="ytSubModal">
            <p className="vipKicker">@3000Studio</p>
            <h2>Subscribe on YouTube</h2>
            <p>
              Official DistroKid videos live on the channel. This box never covers the page until
              you tap Subscribe.
            </p>
            <div className="heroActions">
              <a
                className="studioButton ytCta ytPerkSafe"
                href={SUBSCRIBE_URL}
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                className="studioButton secondary ytPerkSafe"
              ...
              <button
                type="button"
                className="studioButton ghost ytPerkSafe"
